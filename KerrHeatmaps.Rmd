...
Try the function on a few sites and parameters.
...
int_heatmap(kerr, stationFilter = '4AROA022.52', yearFilter = 2012, 
            ...
            dateCol = Date, 
            depthCol = Depth, 
            parameterCol = `Field Ph`, 
            criteriaCol = `pH Min`,
            dateFormat= '%Y-%m-%d',
            reverseColorPalette = TRUE)
```

other testing 4AROA043.14, 4ABHB004.40, 4ABMA002.00, 4ABST001.13, 4ADAN000.00


```{r}

rawData <- kerr
stationFilter <- '4AROA43.14'
yearFilter <- 2012

int_heatmap(kerr, stationFilter = '4AROA043.14', yearFilter = 2012, 
            stationCol = FDT_STA_ID,
            dateCol = Date, 
            depthCol = Depth, 
            parameterCol = `Field Ph`, 
...
View(filter(kerr, FDT_STA_ID== '4AROA043.14'))
```
